...
const bookswithusersAPI_auto = {

    /** Gets all entries from 'bookswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/bookswithusers`, requestOptions);
        return response.data;
    },
};

export { bookswithusersAPI_auto };